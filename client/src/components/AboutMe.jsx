  ...
  return (
    <div>
      <div className="z-10 relative grid md:grid-cols-2 grid-rows-1 overflow-visible">
        ...
        {/* Text Section */}
        <div className="grid1 md:z-20 place-content-center mx-[50px] md:mt-0 -mt-[400px] md:text-start text-center relative z-20">
          <div className="drop-shadow-[0px_0px_16px_rgba(255,255,255,0.6)] animate-glow">
            <div className="card-name-description-label">
              <div className="card-name">
                ...
                <h1 className="md:text-9xl text-8xl md:text-[240px] font-secondary">MARCELO</h1>
              </div>
              <div className="card-description-label flex flex-col md:flex-col-reverse items-center md:items-start justify-center gap-5">
                ...
                <p className="md:text-base text-sm card-description md:-mt-[20px] drop-shadow-[0px_0px_16px_rgba(255,255,255,0.6)]">
