...
import CardBackground from "../../assets/Websites/Placeperfect-Background.jpg";
import CardWebsite from "../../assets/Websites/Placeperfect-Website.png";
...
export const ProjectsCard101 = () => {
  ...
  return (
    ...
    <div className="card w-full h-[600px] md:h-[402px] rounded-3xl border border-gray-500 overflow-hidden relative group">    
        ...
        >
          <h1 className='md:text-4xl text-3xl font-black mb-2'>PLACEPERFECT</h1>
          <p className='font-thin text-sm tracking-wide'>FRONTEND DESIGN</p>
        </div>
        ...
        >
          <div className='card-informaton-title'>
            <h1 className='md:text-4xl text-3xl font-black mb-1'>PLACEPERFECT</h1>
            <p className='font-normal italic text-xs tracking-widest mb-5'>FRONTEND DESIGN</p>
          </div>
          <div className='card-description text-justify md:text-base text-xs'>
            <p>
            Introducing PlacePerfect, a property management platform designed in Figma using modern design trends. Simplify operations, manage bookings, inventory, and cleaning schedules with ease. Gain valuable insights with comprehensive reports.
            </p>
          </div>
          ...
          <div className='card-technology-link-section md:grid grid-cols-2 mt-5'>
            <div className='card-technology md:text-sm text-xs'>
              ...
              <div className='md:grid grid-cols-2 gap-[5px] mt-5 flex flex-col'>
                <div className='information-title-example gap-3 flex'>
                  <p className='font-semibold uppercase'>Design:</p>
                  <p className='font-light uppercase'>Figma</p>
                </div>
              </div>
            </div>
                ...
                <div className='logo-content pt-4 flex gap-5 justify-center items-center'>
                  ...
                  {/* Figma Logo with Link */}
                                        <a 
                    href="https://www.figma.com/design/pE3dgKirBAOpKf6ye56CS2/PROJECT%3A-PLACEPERFECT?node-id=17-175&t=QYYWsxcwXaaOC1d9-1" 
                    target="_blank" 
